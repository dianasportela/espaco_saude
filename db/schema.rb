...
ActiveRecord::Schema[7.2].define(version: 2024_09_22_182513) do
  ...
  create_table "area_icds", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "daily_question_alternatives", force: :cascade do |t|
    t.string "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "health_areas", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "social_support_places", force: :cascade do |t|
    t.string "name"
    t.string "address"
    t.string "email"
  ...
  create_table "survey_question_alternatives", force: :cascade do |t|
    t.string "content"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
